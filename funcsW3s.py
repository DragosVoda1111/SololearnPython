...
def my_function(food):
    for x in food:
        print(x+"!")               #prints out the FOR LOOP LIST of each element in the "fruits" varible
...
def my_function(*food):
    for x in food:
        print(x[2]+"!")       #here it prints out the argument on the index 2 position. x  is the index 2 position of the argument "fruits" in this case with value "cherry3" in this case



fruits = ["apple","banana","cherry3"]
...
def my_function(*food):
    for x in food:
        print(x[2]+"!")           #here it prints out the second index of each argument. x is itterated in each letter of each argument because it's NOT A LIST
